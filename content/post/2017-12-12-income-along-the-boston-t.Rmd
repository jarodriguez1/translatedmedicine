...
I pulled together the names and locations(longitide/latitude) of the [Orange Line stations](../mbta_orange.csv). I needed to change the longitude and latitude to numerics for later use. 
```{r eval=FALSE}
...
#### Census Tracts 
Since I wanted to know the median household income by census tract, I needed to convert the T station coordinates to census tracts. I used the httr package to use the census geocoder website. The end of the code gets a little confusing due to the way the geocoding website returns the data.
